            ...
            <div class="col-75">
                <div class="container1" id="miao">
                            ...
                            <div class="col-50">
                                ...
                                <div class="row">
                                    <div class="col-50">
                                        ...
                                        <input type="text" id="state" name="state" placeholder="KL" required onblur="uppercase()">
                                    </div>
                                    <div class="col-50">
                        ...
                        <label>
                            ...
                            <div>
                        <span>
                                <input type="reset" value="Reset this transaction" class="btn btn-lg btn-danger text-white" style="width: 33%" >
                                <input type="submit" value="Continue to checkout" class="btn btn-lg btn-success text-white" style="width: 33%;" >
                                <input type="reset" value="Cancel this transaction" class="btn btn-lg btn-danger text-white" style="width: 33%" onclick="hideModal()" >
                            </span>
    </div>
                    </form>
                </div>
