...
include($_SERVER['DOCUMENT_ROOT'] . "/test/php-assignment/php_common/" . "renderWelcome.php");
session_start();
        ...
        <div class="list-group col-lg-2 p-3">
            <div class="row ">
                ...
                <div class="col-lg-2 p-0 m-0 ">
                    <a id="hideShowSideBtn" value='#' class="btn btn-primary hsbtn" role="button" onclick="hideSidePanel()" title="Click to close side panel">
                    </a>
                </div>
            </div>
        </div>
