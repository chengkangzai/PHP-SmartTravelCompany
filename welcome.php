...
<div class="row">
        ...
        <div class="row ">
            <div class="col-lg-10 m-0 pl-3 pr-0" id="sidePanel">
                ...
                <a class="list-group-item list-group-item-action btn btn-primary" href='#' onclick="showSixthPanel()"
                   id="delete-trip-btn"> View Report</a>
                <?php
                if ($position == "Manager" || $position == "Assistant Manager") {
            ...
            <div class="col-lg-2 p-0 m-0 ">
                <a id="hideShowSideBtn" value='#' class="btn btn-primary hsbtn" role="button" onclick="hideSidePanel()"
                   title="Click to close side panel">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-10" id="contentPanel6">
        <?php echo $GLOBALS['welcomeText']; ?>
        <div>
            <a id="btnShowTourReportInTableSection" class="btn btn-primary text-white"
               onclick="showTourReportInTableSection()">Tour Report In table </a>
            <a id="btnShowTourReportInBarSection" class="btn btn-primary text-white"
               onclick="showTourReportInBarSection()">Tour Report In Bar </a>
        </div>
        <?php
