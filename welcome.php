...
<body>
    ...
    <div class="row m-3">
        ...
        <div class="list-group col-lg-2">
            ...
            <a class="list-group-item list-group-item-action" onclick="showManageTrip()">View Managed Trip</a>
        ...
        <div class="col-lg-10 d-block" id="Update-Tour">
            <?php
            //https://www.youtube.com/watch?v=JaRq73y5MJk upload pending
