        ...
        <div class="newsletter-subscribe">
            <div class="container">
                <div class="intro">
                    ...
                    <p class="text-center">We are always happy receive feedback from our users! Because that is that
                        makes
                ...
                <form method="post">
                    <div class="form-group">
                        <textarea name="Feedback" rows="10" class="form-control"
                                  placeholder="Enter your Feedback here :3"></textarea>
    ...
    <div class="col-lg-6">
        <div class="map-clean">
            ...
            <iframe allowfullscreen="" frameborder="0"
                    src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAmHPAyIIGU5EzeGOpVrWT43l3YbGAYaWk&amp;q=Roytstar&amp;zoom=15"
