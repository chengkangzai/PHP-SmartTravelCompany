...
<input type="text" name="LName" placeholder="Your Last Name" class="form-control">
    <br>
<input type="number" name="IC" id="" placeholder="Your Idenditication Card Number" class="form-control">
    <br>
<select name="Position" id="" class="form-control"  >
    <option value="" disabled selected hidden> Your Position</option>
    <option value="Manager">Manager</option>
    <option value="Full Timer">Full time staff</option>
    <option value="Part Timer">Part time staff</option>
</select>
    <br>
