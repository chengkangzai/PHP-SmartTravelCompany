...
<div class="row m-3">
    ...
    <div class="list-group col-lg-2">
        <a class="list-group-item list-group-item-action bg-dark text-white" onclick="showprofile()" id="profile-btn">
            Profile </a>
    ...
    <div class="col-lg-10 d-none" id="Profile">
        ...
        <form action="php_common/edit_customer_profile" method="post">
            <table class="table table-dark table-striped table-hover table-bordered">
                <tr>
                    <td>User Name</td>
                    <td><input class="form-control" type="text" value="<?php echo $login_session; ?>" name="username"
                               hidden> <?php echo $login_session; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>First Name</td>
                    <td><input type="text" class="form-control" name="FirstName" value="<?php echo $FName; ?>" required>
                    </td>
                </tr>
                <tr>
                    <td>Last Name</td>
                    <td><input type="text" name="LastName" class="form-control" value="<?php echo $LName; ?>" required>
                    </td>
                </tr>
                <tr>
                    <td>Phone Number</td>
                    <td><input type="text" name="phone_num" class="form-control" value="<?php echo $phone_number; ?>"
                               required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Email</td>
                    <td><input type="email" name="email" class="form-control" value="<?php echo $Email; ?>" required>
                    </td>
                </tr>
                <tr>
